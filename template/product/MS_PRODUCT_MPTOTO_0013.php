                ...
                <div class="col-md-9">
                    ...
                    <div class="gb-productcat_mptoto-item">
                        <div class="gb-productcat_mptoto-title">
                            ...
                            <a href="/<?= $rowCatLang['friendly_url'] ?>" class="btn_xemthem"><?= $lang=='vn' ? 'Xem thêm' : 'See more' ?></a>
                        </div>
                        <div>
                            <?= $rowCatLang['lang_productcat_content'] ?>
                        </div>
                        <div class="row">
                            <?php
                                foreach ($rows as $row) {
                                    $row_product_cat = $action_product->getProductCatDetail_byId($row['productcat_id'], $lang);
                                    $row_product_cat_lang = $action_product->getProductCatLangDetail_byId($row['productcat_id'], $lang);
                            ?>
                            <div class="col-sm-4">
                                <div class="gb-product-item_mptoto">
                                    <div class="gb-product-item-img">
                                        <div class="gb-product-item-img-main">
                                            <a href="/<?= $row_product_cat_lang['friendly_url'] ?>">
                                                <img src="/images/<?= $row_product_cat['productcat_img'] ?>" alt="" class="img-responsive">
                                            </a>
                                        </div>
                                        <div class="gb-product-item-img-replate">
                                            <a href="/<?= $row_product_cat_lang['friendly_url'] ?>">
                                    ...
                                    <div class="gb-product-item-img-text">
                                        <h2>
                                            <a href="/<?= $row_product_cat_lang['friendly_url'] ?>">
                                                <?= $row_product_cat_lang['lang_productcat_name'] ?>
                                            </a>
                                        </h2>
                                        <p><?= $row_product_cat_lang['lang_productcat_des'] ?></p>
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
